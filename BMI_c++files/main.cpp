...
int main()
{
	...
	"Patient Height: " << Student_1.getHeight() << endl << "Patient Weight: " <<
	Student_1.getWeight() << endl;
	...
	"Patient Height: " << Student_2.getHeight() << endl << "Patient Weight: " <<
	Student_2.getWeight() << endl << 
